...
const clientData = ref(null);  // Initialize clientData as null
                ...
                <div class="flex-1 flex-col space-y-20">
                    ...
                    <div class=" flex flex-col justify-between text-black">
                       <div>
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2 ml-4">Genre</label>
                            <div class="flex items-center ml-4">
                                <input type="radio" id="homme" v-model="form.gender" value="homme" class="mr-2">
                                <label for="homme" class="mr-4">Homme</label>
                                <input type="radio" id="femme" v-model="form.gender" value="femme" class="mr-2">
